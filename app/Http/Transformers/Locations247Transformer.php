...
class Locations247Transformer
{
    ...
    public function transformLocation(Location247 $location = null)
    {
        if ($location) {
            ...
            $permissions_array['available_actions'] = [
                'update' => Gate::allows('update', Location247::class) ? true : false,
                'delete' => (Gate::allows('delete', Location247::class) && ($location->assigned_assets_count==0) && ($location->assets_count==0) && ($location->users_count==0) && ($location->deleted_at=='')) ? true : false,
            ];
