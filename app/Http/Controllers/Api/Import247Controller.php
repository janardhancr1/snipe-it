...
use App\Http\Requests\ItemImport247Request;
...
class Import247Controller extends Controller
{
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function process(ItemImport247Request $request, $import_id)
    {
        ...
        if ($errors) { //Failure
            return response()->json(Helper::formatStandardApiResponse('import247-errors', null, $errors), 500);
        }
