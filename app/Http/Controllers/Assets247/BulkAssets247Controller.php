...
class BulkAssets247Controller extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->filled('bulk_actions')) {
            switch($request->input('bulk_actions')) {
                case 'labels':
                    return view('hardware247/labels')
                ...
                case 'delete':
                    ...
                    return view('hardware247/bulk-delete')->with('assets', $assets);
                case 'edit':
                    return view('hardware247/bulk')
    ...
    public function update(Request $request)
    {
        ...
        if(!$request->filled('ids') || count($request->input('ids')) <= 0) {
            return redirect()->route("hardware247.index")->with('warning', trans('No assets selected, so nothing was updated.'));
        }
    ...
    public function showCheckout()
    {
        ...
        return view('hardware247/bulk-checkout');
    }
