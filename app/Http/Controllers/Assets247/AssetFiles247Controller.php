...
class AssetFiles247Controller extends Controller
{
    /**
    ...
    public function store(AssetFileRequest $request, $assetId = null)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            foreach ($request->file('file') as $file) {
                ...
                $file_name = 'hardware247-'.$asset->id.'-'.str_random(8).'-'.str_slug(basename($file->getClientOriginalName(), '.'.$extension)).'.'.$extension;
