...
use App\Importer247\AccessoryImporter;
use App\Importer247\AssetImporter;
use App\Importer247\ConsumableImporter;
use App\Importer247\Importer;
 ...
 */
class ObjectImportCommand247 extends Command
{
     ...
     * @var string
     */
    protected $name = 'snipeit:import247';
    ...
    public function handle()
    {
        ...
        $classString = "App\\Importer247\\{$class}Importer";
