 ...
 * @version    v1.0
 */
class Category247 extends SnipeModel
{
    protected $presenter = 'App\Presenters\Category247Presenter';
    use Presentable;
    use SoftDeletes;
    ...
    */
    ...
    {
        return $this->hasMany('\App\Models\License', 'category_id');
    }
    ...
    {
        return $this->hasMany('\App\Models\Consumable', 'category_id');
    }
    ...
    {
        return $this->hasMany('\App\Models\Component', 'category_id');
    }
    ...
    /**
     * Establishes the category -> erp category relationship
     *
     * @author [A. Gianotto] [<snipe@snipe.net>]
     * @since [v2.0]
     * @return \Illuminate\Database\Eloquent\Relations\Relation
    ...
    {
        return $this->belongsTo('\App\Models\ErpCategory', 'erp_category_id');
    }
