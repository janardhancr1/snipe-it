...
<script>
    ...
    export default {
        ...
        mounted() {
            window.eventHub.$on('import247Errors', this.updateImportErrors);
            this.fetchFiles();
        ...
        methods: {
            fetchFiles() {
                this.$http.get(route('api.imports247.index'))
            ...
            deleteFile(file, key) {
                this.$http.delete(route('api.imports247.destroy', file.id))
                .then(
        ...
        components: {
            ...
            errors: require('./importer247-errors.vue'),
            importFile: require('./importer247-file.vue'),
        }
    }
