...
<div class="dropdown pull-right">
  ...
  <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1">
    @if (($asset->assetstatus) && ($asset->assetstatus->deployable=='1'))
      ...
      <li role="presentation"><a href="{{ route('checkin/hardware247', $asset->id) }}">{{ trans('admin/hardware/general.checkin') }}</a></li>
          @endcan
      @else
       @can('checkout', \App\Models\Asset::class)
      <li role="presentation"><a href="{{ route('checkout/hardware247', $asset->id)  }}">{{ trans('admin/hardware/general.checkout') }}</a></li>
          @endcan
      @endif
    @endif
      @can('update', \App\Models\Asset::class)
    <li role="presentation"><a href="{{ route('hardware247.edit', $asset->id) }}">{{ trans('admin/hardware/general.edit') }}</a></li>
      @endcan
      @can('create', \App\Models\Asset::class)
    <li role="presentation"><a href="{{ route('clone/hardware247', $asset->id) }}">{{ trans('admin/hardware/general.clone') }}</a></li>
      @endcan
  ...
  @if ($asset->deleted_at!='')
    <div class="col-md-12">
      <div class="alert alert-danger">
        ...
        You must <a href="{{ route('restore/hardware247', $asset->id) }}">restore it</a> before you can assign it to someone.
      </div>
    </div>
  @endif
            ...
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                ...
                <table
                        ...
                        data-url="{{route('api.assets247.index',['assigned_to' => $asset->id, 'assigned_type' => 'App\Models\Asset']) }}"
                        data-export-options='{
