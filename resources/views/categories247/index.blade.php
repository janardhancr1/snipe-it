...
<a href="{{ route('categories247.create') }}" class="btn btn-primary pull-right">
  ...
  <div class="col-md-12">
    <div class="box box-default">
      <div class="box-body">
        ...
        <table
            data-columns="{{ \App\Presenters\Category247Presenter::dataTableLayout() }}"
            ...
            data-url="{{ route('api.categories247.index') }}"
            data-export-options='{
